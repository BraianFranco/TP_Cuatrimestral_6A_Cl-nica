...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form class="row g-3">
        <div id="ContenedorRegistroMedico">
            ...
            <div class="col-md-12">
                <asp:Button ID="btnAgregarEspecialidad" CssClass="btn btn-dark" runat="server" Text="AGREGAR" />
                <asp:Button ID="btnCancelarEspecialidad" CssClass="btn btn-dark" runat="server" Text="CANCELAR" />
            </div>
        </div>
    </form>
